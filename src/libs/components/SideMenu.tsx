...
const SideMenu = () => {
  ...
  return (
    <div className="bg-[#242424] w-[100px] h-full flex flex-col gap-[40px] pt-5 items-center ">
      <Image src="img/icons/menu-logo.svg" alt="menu-icon" width={47} height={47} className="mb-7" />
      {active === 'home' ? (
