  ...
  return (
    <div className="w-full">
      <div id="mid-top" className="flex justify-between w-[50%] pt-5 items-center">
        ...
        <p className='text-[32px]' style={{ fontFamily: "Qwigley, cursive" }}>Dashboard</p>
      </div>
      <div className='w-full mt-2 mt-[30px] flex flex-col gap-5'>
        ...
        <div className='flex gap-7 flex-col'>
          <div id="cards" className='flex justify-between'>
            <div id="card" className='relative w-[300px] h-[160px] bg-[#0bf4c8] rounded-4xl text-black flex justify-center items-center bg-[url("/img/icons/bg-rect-repeat.svg")] bg-repeat bg-[length:150px_100px]'>
            ...
            <div id="card" className='relative w-[300px] h-[160px] bg-[#fad85d] rounded-4xl text-black flex justify-center items-center bg-[url("/img/icons/bg-rect-repeat.svg")] bg-repeat bg-[length:200px_100px]'>
              <div className='w-[80%] h-[70%] flex flex-col justify-between '>
            ...
            <div id="card" className='relative w-[300px] h-[160px] bg-[#f2a0ff] rounded-4xl text-black flex justify-center items-center bg-[url("/img/icons/bg-rect-repeat.svg")] bg-repeat bg-[length:150px_80px]'>
              <div className='w-[80%] h-[70%] flex flex-col justify-between '>
